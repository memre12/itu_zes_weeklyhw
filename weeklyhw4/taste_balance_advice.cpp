...
void taste_balance_advice::set_preference() {
    ...
    while (true)
    {
        std::cout << "Please input your taste_balance values (values shoulde be between 1-10(10 and 1 do not include.))" << std::endl;  
        std::cout << "Sweet: ";
        std::cin >> sweet;              
        if (sweet>0 && sweet<10)
        {
            ...
            std::cerr << "TRY AGAIN!!!\nInvalid value, value shoulde be between 1-10(10 and 1 do not include.)" << std::endl;
        }
    }
